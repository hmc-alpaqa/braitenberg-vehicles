...
class Vehicle {
    ...
    /**
     * Advances the robot's position and rotation by a small time step
     * @param {number} dt - The amount of time to advance the robot by
     */
    step(dt) {
        this.move(dt);
        this.rotate(dt);
    ...
    /**
     * Uses an instantaneous approximation of the robot's motion to predict its
     * position some small time step in the future
     * @param {Number} dt - The amount of time to step the robot by
     */
    move(dt) {
        let netForce = 0;
