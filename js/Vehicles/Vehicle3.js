...
function Vehicle3a(u, x, y) {
    ...
    let inhibitor1 = new Inhibitor(gyro, new Vector(-1, -2), [sensor2], -1, 300);
    let inhibitor2 = new Inhibitor(gyro, new Vector(-1, 2), [sensor1], -1, 300);
...
function Vehicle3b(u, x, y) {
    ...
    let sensor2 = new Sensor(gyro, new Vector(1, 2));
    // wires sensor to same inhibitor
    let inhibitor1 = new Inhibitor(gyro, new Vector(-1, -2), [sensor1], -1, 300);
    let inhibitor2 = new Inhibitor(gyro, new Vector(-1, 2), [sensor2], -1, 300);
    let vehicle = new Vehicle(gyro, [sensor1, sensor2], [], [inhibitor1, inhibitor2]);
    return vehicle;
}